...
import com.RookieWZW.spring.boot.blog.service.CatalogService;
...
/**
 * @author RookieWZW
 * @version 创建时间：2018年9月4日 上午9:14:16 类说明
 */
@Controller
@RequestMapping("/u")
public class UserspaceController {
	...
	public ModelAndView editBlog(@PathVariable("username")String username,Model model,@PathVariable("id")Long id) {
		User user = (User)userDetailsService.loadUserByUsername(username);
		List<Catalog> catalogs = catalogService.listCatalogs(user);
